...
document.querySelector("#menu").addEventListener("click", function () {
  if(flag == 0){
    ...
    document.querySelector("#line1").style.rotate = "46deg"
    document.querySelector("#line2").style.rotate = "-47deg"
    document.querySelector("#full-scrn").style.top = "0"
    flag = 1
  }else{
    ...
    document.querySelector("#full-scrn").style.top = "-100%"
    flag = 0
  }
...
all.forEach(function(e){
  ...
  e.addEventListener("mouseleave", function(){
    ...
    document.querySelector("#cursor").style.borderColor = "#f5f5f5"
  })
